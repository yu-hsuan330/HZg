...
samples = [
    ...
    
    {
        ...
        "Color": "#000000",
        "Label": "Data", 
        "epath": ["../../minitrees_HBID/data/UL16_preVFP_ele_data*.root", "../../minitrees_HBID/data/UL16_postVFP_ele_data*.root", "../../minitrees_HBID/data/UL17_ele_data*.root", "../../minitrees_HBID/data/UL18_ele_data*.root"],
        "upath": [],
